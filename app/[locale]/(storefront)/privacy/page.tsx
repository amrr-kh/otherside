...
const AR_INTRO = [
  ...
  "OtherSide علامة أزياء مصرية يديرها مؤسسوها Bidu وEshta وAmr. توضح سياسة الخصوصية هذه المعلومات التي نجمعها، وأسباب جمعها، وكيفية استخدامها، والخيارات المتاحة لك.",
];
