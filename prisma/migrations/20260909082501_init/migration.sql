...
-- CreateEnum
CREATE TYPE "ImageRole" AS ENUM ('FRONT', 'BACK', 'SIDE', 'DETAIL', 'FIT', 'LIFESTYLE');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('RECEIVED', 'CONFIRMED', 'PREPARING', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURNED');
...
CREATE TABLE "ProductImage" (
    "id" TEXT NOT NULL,
    "productId" TEXT NOT NULL,
    "colorOptionValueId" TEXT NOT NULL,
    "url" TEXT NOT NULL,
...
CREATE TABLE "Order" (
    ...
    "codPaid" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "ProductImage_productId_colorOptionValueId_idx" ON "ProductImage"("productId", "colorOptionValueId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Wishlist_guestToken_key" ON "Wishlist"("guestToken");
...
-- AddForeignKey
ALTER TABLE "ProductImage" ADD CONSTRAINT "ProductImage_colorOptionValueId_fkey" FOREIGN KEY ("colorOptionValueId") REFERENCES "ProductOptionValue"("id") ON DELETE CASCADE ON UPDATE CASCADE;
